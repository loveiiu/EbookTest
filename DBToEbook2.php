...
<h3 style="font-family:Microsoft JhengHei;">(2)&nbsp;搬檔案到Mac上</h3>
<?php 
...
if(isset($_POST['ButtonPushChecker'])) {
    //echo 'Executing';
	$output = shell_exec('C:\ProgramData\Oracle\Java\javapath\java.exe -jar C:\javarun\DBToEbook\(2)copyZipToMacBatch.jar');
	$output1 = iconv("BIG5", "UTF-8", $output);
	echo "<pre>$output1</pre>";
} else {
    echo '<form action="copyZipToMacBatch.php" method="post">', 
