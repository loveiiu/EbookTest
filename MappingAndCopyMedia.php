...
<h3 style="font-family:Microsoft JhengHei;">後台填寫完畢再次匯入及放入暫存區</h3>

<?php 

if(isset($_POST['orgprodid'])) {
    //echo 'Executing';
	$string = 'C:\ProgramData\Oracle\Java\javapath\java.exe -jar C:\javarun\MediaProcess\MappingAndCopyMedia.jar '.$_POST['orgprodid'];
	echo $string;
	$output = shell_exec($string);
	$output1 = iconv("BIG5", "UTF-8", $output);
	echo "<pre>$output1</pre>";
} else {
    echo '<form action="MappingAndCopyMedia.php" method="post">', 
...
<?php
	...
	//mysqli_query(ԳղǗۙ,"SET CHARACTER SET UTF8");
